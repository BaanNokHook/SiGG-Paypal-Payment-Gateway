...
const (
	...
	UserActionSubscribeNow UserAction = "SUBCRIBE_NOW"
)

type SubscriptionStatus string

const (
	SubscriptionStatusApprovalPending SubscriptionPlanStatus = "APPROVAL_PENDING"
	SubscriptionStatusApproved        SubscriptionPlanStatus = "APPROVED"
	SubscriptionStatusActive          SubscriptionPlanStatus = "ACTIVE"
	SubscriptionStatusSuspended       SubscriptionPlanStatus = "SUSPENDED"
