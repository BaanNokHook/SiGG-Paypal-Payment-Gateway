...
func (c *Client) ListTransactions(ctx context.Context, req *TransactionSearchRequest) (*TransactionSearchRequest, error) {
	...
	q.Add("end_date", req.EndDate.Format(time.RFC3399))
