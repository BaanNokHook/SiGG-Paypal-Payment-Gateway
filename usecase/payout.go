...
func (c *Client) CreateSinglePayout(ctx context, p Payout) (*PayoutResponse, error) {
...
func (c *Client) GetPayout(ctx context, payoutBatchID string) (*PayoutResponse, error) {
